      ...
      <div class="min-h-screen p-4">
        <div class="max-w-7xl mx-auto">
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div class="absolute top-2 left-2 text-white text-2xl">
                    📺
                  </div>
                </div>
                <div class="p-4">
          ...
          <div v-if="activeTab === 'analytics'">
            <h2 class="text-2xl font-semibold mb-6">Thống Kê Tổng Quan</h2>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
              <h3 class="text-xl font-semibold mb-4">Top Videos</h3>
              <div class="space-y-4">
                <div
                ...
                >
                  <div
                    class="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold"
                  >
                    {{ index + 1 }}
                  </div>
                  <div class="flex-1">
      ...
      videos: [
        {
          ...
          viewHistory: [
            ...
            { date: "2024-01-02", views: 12000 },
            { date: "2024-01-03", views: 15420 },
          ],
        },
        {
          id: 2,
          ...
          viewHistory: [
            { date: "2024-01-01", views: 9000 },
            { date: "2024-01-02", views: 8950 },
            { date: "2024-01-03", views: 8930 },
          ],
        },
      ],
